...
@SpringApplicationConfiguration(classes={ApplicationConfig.class, ServiceConfig.class,
		WebMvcConfig.class, RepositoryConfig.class, WebAppControllerTest.SecurityConfig.class})
@WebAppConfiguration
@ActiveProfiles("test")
